...
fun SvgIcons.winPinFill(color: Color = Color(0xFF636363)): ImageVector {
    var imageVector = cache[color]
    if (imageVector != null) {
        return imageVector
    }
    imageVector = Builder(
        name = "WinPinFill", defaultWidth = 1024.0.dp, defaultHeight =
...
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = SvgIcons.winPinFill(), contentDescription = "")
    }
}
