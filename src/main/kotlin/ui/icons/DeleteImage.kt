...
val SvgIcons.DeleteImage: ImageVector
    get() {
        if (cache != null) {
            return cache!!
        }
        cache = Builder(name = "DeleteImage", defaultWidth = 1024.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFFB3E5FC)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(192.0f, 554.7f)
                horizontalLineToRelative(640.0f)
                verticalLineToRelative(-106.7f)
                lineTo(192.0f, 426.7f)
            ...
            path(fill = SolidColor(Color(0xFFF44336)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(832.0f, 832.0f)
                moveToRelative(-192.0f, 0.0f)
                arcToRelative(192.0f, 192.0f, 0.0f,
                    isMoreThanHalf = true,
                    isPositiveArc = false,
                    dx1 = 384.0f,
                    dy1 = 0.0f
            ...
            path(fill = SolidColor(Color(0xFFFDFDFD)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(896.0f, 736.1f)
                lineToRelative(32.0f, 32.0f)
                lineToRelative(-160.1f, 160.0f)
                lineToRelative(-32.0f, -32.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFFFDFDFD)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(927.9f, 896.0f)
                lineToRelative(-32.0f, 32.0f)
                lineToRelative(-160.0f, -160.1f)
                lineToRelative(32.0f, -32.0f)
                close()
            }
        }
...
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = SvgIcons.DeleteImage, contentDescription = "")
    }
}
